    ...
    {                                                                                                                  \
        ...
        INTERNAL_CATCH_REACT(catchAssertionHandler)                                                                    \
             ...
             false && static_cast<bool>(!!(                                                                            \
                          __VA_ARGS__))) // the expression here is never evaluated at runtime but it forces the compiler
                                         // to give it a look The double negation silences MSVC's C4800 warning, the
                                         // static_cast forces short-circuit evaluation if the type has overloaded &&.
